export default function PrivacyPolicy() {
  return (
    <div>
      <h1>Cookie policy</h1>
      <p>
        This cookie policy (&quot;Policy&quot;) describes what cookies are and how Website Operator
        (&quot;Website Operator&quot;, &quot;we&quot;, &quot;us&quot; or &quot;our&quot;) uses them
        on the{' '}
        <a target="_blank" rel="nofollow" href="https://eirevpn.ie">
          eirevpn.ie
        </a>{' '}
      ...
      <p>
        ...
        <a target="_blank" rel="nofollow" href="https://eirevpn.ie/privacy-policy">
          Privacy Policy
        </a>
        .
      </p>
      ...
      <p>
        ...
        (&quot;third party cookies&quot;). These third parties can recognize you when you visit our
      ...
      <p>
        ...
        able to use all of the features our Website and Services offer.
      </p>
      ...
      <p>
        ...
        using the Website or its Services you agree to be bound by this Policy. If you do not agree
        to abide by the terms of this Policy, you are not authorized to use or access the Website
        and its Services.
      </p>
      <h2>Contacting us</h2>
      <p>
        If you would like to contact us to understand more about this Policy or wish to contact us
        concerning any matter relating to our use of cookies, you may do so via the{' '}
        <a target="_blank" rel="nofollow" href="https://eirevpn.ie/contact">
          contact form
        </a>
      </p>
      <p>This document was last updated on February 20, 2020</p>
    </div>
  );
}
